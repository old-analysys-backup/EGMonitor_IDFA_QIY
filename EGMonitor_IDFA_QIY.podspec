#
#  Be sure to run `pod spec lint EGMonitor_IDFA_QIY.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/analysys/EGMonitor_IDFA_QIY.git", :tag => spec.version }  
